                    ...
                    <asp:GridView ID="CustomerTable" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="First Name">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtEditFirstName" runat="server" Text='<%# Bind("FirstName") %>' CssClass="form-control" />
                                </EditItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Last Name">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtEditLastName" runat="server" Text='<%# Bind("LastName") %>' CssClass="form-control" />
                                </EditItemTemplate>
                            </asp:TemplateField>
